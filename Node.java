/***
 * Class used to represent one node of a binary tree the node can store a
 * character
 ***/

public class Node {
	// data members (private)
	protected char data; // the character stored in the node
	protected BinaryTree left; // left child
	protected BinaryTree right; // right child

	// OPERATIONS

	// CONSTRUCTOR
	/***
	 * Creates a new node, storing a given data the new node has no children to
	 * start with
	 *
	 * @param d
	 *            the character to be stored in the node
	 ***/
	public Node(char d) {
		data = d;
		left = new BinaryTree();
	 ...
	 *
	 * @param d
	 *            the new character to be stored in the node
	 ***/
